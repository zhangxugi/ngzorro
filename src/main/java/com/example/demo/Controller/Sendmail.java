...
public class Sendmail {
    //发件人地址
    public static String senderAddress = "1339686634@qq.com";
    //收件人地址"
    public static String recipientAddress = "1413088718@qq.com";
    //发件人账户名
    public static String senderAccount = "1339686634@qq.com";
    //发件人账户密码
    public static String senderPassword = "jsquozpzenyfgeib";
     ...
     *//*
            ...
            //设置邮件正文
            msg.setContent("张旭发送！", "text/html;charset=UTF-8");
            //设置邮件的发送时间,默认立即发送
